trace_config = dict(
    ...
    neck_detail = dict(
        ...
        further_detail = dict(
        exclude_prefixes = [],  
        removed_quantizer_names = ['getitem_0_post_act_fake_quantizer'],  
        specified_general_quantizers = ['getitem_1_post_act_fake_quantizer'],  # 0号有负
        last_8bit_module = []
    )),
    bbox_head_detail = dict(
        ...
        further_detail = dict(
        exclude_prefixes = [],  
        removed_quantizer_names = ['getitem_post_act_fake_quantizer','getitem_1_post_act_fake_quantizer','getitem_2_post_act_fake_quantizer','getitem_3_post_act_fake_quantizer','getitem_4_post_act_fake_quantizer'],  
        qloss_flag = True, 
        ...
        specified_general_quantizers = ['getitem_5_post_act_fake_quantizer'],  # 0号有负的
        last_8bit_module = ['cls_convs.0.1', 'cls_convs.1.1', 'cls_convs.2.1', 'cls_convs.3.1', 'cls_convs.4.1'
                            , 'cls_convs.5.1', 'reg_convs.0.1', 'reg_convs.1.1',  'reg_convs.2.1', 'reg_convs.3.1', 'reg_convs.4.1',  'reg_convs.5.1']  # fold不会影响 似乎
    )))