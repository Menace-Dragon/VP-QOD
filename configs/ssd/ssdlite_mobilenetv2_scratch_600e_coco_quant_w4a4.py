_base_ = [
    '../_base_/datasets/coco_detection.py', '../_base_/default_runtime.py', '../_base_/schedules/schedule_qat_w4a4.py'
    , 'ssd300_quant_general.py'
]
...
load_from = '../long_used_pretrained/ssdlite_mobilenetv2_scratch_600e_coco_20210629_110627-974d9307.pth'
