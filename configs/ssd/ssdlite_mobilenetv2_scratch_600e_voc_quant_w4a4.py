_base_ = [
    '../_base_/datasets/voc0712.py', '../_base_/default_runtime.py', '../_base_/schedules/schedule_qat_w4a4.py'
    , 'ssdlite_quant_general.py'
]
...
custom_hooks = [
    ...
    dict(type='CheckInvalidLossHook', interval=200, priority='VERY_LOW')
]
...
load_from = '/workspace/share/long_dir/ssdlite_mobilenetv2_scratch_600e_voc/best_bbox_mAP_epoch_30.pth'
